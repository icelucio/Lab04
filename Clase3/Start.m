...
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Welcome to", @"BMW", @"Driving pleasure", nil];
    
    maIntroImgs     = [[NSMutableArray alloc] initWithObjects: @"M.png", @"BMW.png", @"start.jpg", nil];
